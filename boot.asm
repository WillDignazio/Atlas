...
boot_load:
  ...
  mov ax, 0x9000	
  mov ss, ax		; Set stack segment to, WHAT 9000?!
  mov sp, 0		; SS:SP(0)
  sti			; re-enable interrupts
  
  mov [bootdrv], dl	; make sure bootdrive is set 
  call kgLoad		; Load the kernel
  mov si, attempt
  call printxt
  call grabber	; Call the grabber outide of the bootloader

; Load Grabber 
;	- Loads the kernel grabber from the boot drive
